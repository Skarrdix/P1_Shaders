Shader "Unlit/SHDR_PBR"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed _NormalValue, _SmoothnessValue, _MetallicValue, _Anisotropy;
            float4 _MainTex_ST, _AmbientCol;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                return col;
                //return float4(lightValue.xyz, 1);
                //return dot(normalWS, _WorldSpaceLightPos0);
